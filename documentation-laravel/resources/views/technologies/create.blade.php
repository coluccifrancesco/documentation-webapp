...
@section('content')
    ...
    @auth
        @if (Auth::user()->role === 'admin')
            <form action="{{ route('technologies.store') }}" method="POST" enctype="multipart/form-data" class="w-75 mx-auto mt-5 border rounded p-4">
                @csrf
                ...
                <div class="form-control my-3 d-flex align-items-start flex-column">
                    ...
                    <input type="text" name="official_page_link" id="official_page_link" class="w-100"></input>
                </div>
