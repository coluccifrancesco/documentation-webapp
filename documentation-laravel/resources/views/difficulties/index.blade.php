        ...
        <div class="mt-4 mx-3 d-flex justify-content-between align-items-center">
            ...
            @auth
                @if (Auth::user()->role === 'admin')
                    <a href="{{ route('difficulties.create') }}" class="">
                ...
                <div class="col-12 col-lg-6 my-2">
                    <div class="rounded border py-2 px-3 d-flex justify-content-between align-items-center">
                        ...
                        @if ($difficulty->grade_numerical == 1)
                            <div
                                class="border rounded bg-success text-white p-2 d-flex gap-2 align-items-center justify-content-between">
                        ...
                        @elseif ($difficulty->grade_numerical == 3)
                            <div
                                class="border rounded bg-warning text-dark p-2 d-flex gap-2 align-items-center justify-content-between">
                                <p class="mb-0">{{ $difficulty->grade_name }}</p>
                                <p class="mb-0 mx-2">{{ $difficulty->grade_numerical }}</p>
                        ...
                        @elseif ($difficulty->grade_numerical > 4)
                            <div
                                class="border rounded bg-danger text-white p-2 d-flex gap-2 align-items-center justify-content-between">
                                <p class="mb-0">{{ $difficulty->grade_name }}</p>
                                <p class="mb-0 mx-2">{{ $difficulty->grade_numerical }}</p>
