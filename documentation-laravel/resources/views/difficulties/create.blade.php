...
@section('content')
    ...
    @auth
        @if (Auth::user()->role === 'admin')
            ...
            <form action="{{ route('difficulties.store') }}" method="POST" enctype="multipart/form-data" class="w-75 mx-auto mt-5 border rounded p-4">
                @csrf
                ...
                <div class="d-block d-lg-flex justify-content-center align-items-between gap-4">
                    ...
                    <div class="form-control mb-3 mt-4 d-flex align-items-center justify-content-between">
                        ...
                        <input type="number" name="grade_numerical" id="grade_numerical" min="1" max="5">
                    </div>
                </div>
